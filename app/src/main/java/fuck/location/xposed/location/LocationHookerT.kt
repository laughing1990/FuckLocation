...
/**
 * Location Hooker for Android 13 (Tiramisu, API 33)
 *
 * Android 13 的 Location API 与 Android 12 基本相同，
 * 但 CallerIdentity 的字段名可能有所不同。
 */
class LocationHookerT {
    ...
    fun hookDLC(lpparam: XC_LoadPackage.LoadPackageParam) {
        ...
        findAllMethods(clazz) {
            ...
            after {
                try {
                    ...
                    XposedBridge.log("FL: in getLastLocation (T)! Caller package name: $packageName")
                    ...
                    XposedBridge.log("FL: Fuck with exceptions (T)! $e")
                    e.printStackTrace()
                }
            }
        }
        ...
        findAllMethods(clazz) {
            ...
            after { param ->
                ...
                XposedBridge.log("FL: in getCurrentLocation (T)! Caller package name: $packageName")
        ...
        findAllMethods(clazz) {
            ...
            XposedBridge.log("FL: in registerGnssStatusCallback (T, DLC)! Caller package name: $packageName")
        ...
        findAllMethods(clazz) {
            ...
            val packageName = param.args[1] as String
            XposedBridge.log("FL: in registerGnssNmeaCallback (T, DLC)! Caller package name: $packageName")
        ...
        findAllMethods(clazz) {
            ...
            XposedBridge.log("FL: in requestGeofence (T, DLC)! Caller package name: $packageName")
    ...
    private fun hookOnReportLocation(clazz: Class<*>, param: XC_MethodHook.MethodHookParam) {
        XposedBridge.log("FL: in onReportLocation (T)!")
